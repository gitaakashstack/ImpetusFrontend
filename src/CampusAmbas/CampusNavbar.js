...
export default function CaNavbar(props) {
...
const [anchorEl, setAnchorEl] = React.useState(null);
  ...
  const resp = await fetch(`${process.env.REACT_APP_SERVER}/calogout` , {
    method:"GET",
    credentials: "include"
  });
      ...
      <nav>
        <div className="secondNavbar">
         ...
         <h1>Hello {props.name}</h1>
          <ul>
            {window.localStorage.getItem("catoken") ?  <div className="navlinks" onClick={logoutHandler}>
              <li>
                <LogoutIcon
                  style={{
                    fontSize: "2.5rem",
